...
import (
	...
	"github.com/saipengxin/study/day08/registry"
...
func (e *EtcdRegistry) Regiter(ctx context.Context, service *registry.Service) (err error) {
	select {
...
func (e *EtcdRegistry) Unregiter(ctx context.Context, service *registry.Service) (err error) {
	return
}
